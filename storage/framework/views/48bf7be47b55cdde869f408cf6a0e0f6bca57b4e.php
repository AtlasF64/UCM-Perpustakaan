...
<div class="container" style="padding:20px;padding-top:75px">
    ...
    <?php endif;?>
	<div class="row">
		<form class="form-horizontal" enctype="multipart/form-data" style="padding:20px" role="form" method="POST" action="<?php echo e(url('datapeminjaman')); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<select id="id_buku" name="id_buku" class="form-control" required="required">
						...
						<option value="<?php echo e($value->id_buku); ?>" <?php if(isset($_GET['id_buku']) == $value->id_buku) echo 'selected'?>>Kode: <?php echo e($value->kodebuku); ?>, Judul:  <?php echo e($value->judulbuku); ?>, Author: <?php echo e($value->author); ?>, Tahun: <?php echo e($value->tahun); ?></option>
			...
			<div class="form-group">
				<div class="col-md-6 col-md-offset-4">
					<a href="<?php echo e(url('datapeminjaman')); ?>" class="btn btn-primary" style="width:100%;background-color:red">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\UCM-Perpustakaan\resources\views/admin/datatransaksi/datapeminjaman/create.blade.php ENDPATH**/ ?>