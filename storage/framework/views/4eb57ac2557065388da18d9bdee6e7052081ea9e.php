...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="nimnidnnip" type="text" class="form-control <?php $__errorArgs = ['nimnidnnip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="nimnidnnip" value="<?php echo e(old('nimnidnnip')); ?>" required>

                                <?php $__errorArgs = ['nimnidnnip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="nomortelepon" type="number" class="form-control <?php $__errorArgs = ['nomortelepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="nomortelepon" value="<?php echo e(old('nomortelepon')); ?>" placeholder="081234567890" required>
...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <select class="form-control <?php $__errorArgs = ['status_akun'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="status_akun" required>
...
<?php echo $__env->make('ucmlibrary.layouts.appuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\UCM-Perpustakaan\resources\views/auth/register.blade.php ENDPATH**/ ?>