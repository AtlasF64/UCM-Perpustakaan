{{-- 29-3-2023 --}}
{{-- Made Container, Navbar and Sidebar to be individual. --}}
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>UCM Library Dashboard</title>
    <!-- Favicon-->
    ...
    <!-- Core theme JS-->
    <script href="{{ asset('bootstrap-5.0.2-dist/js/bootstrap.bundle.min.js') }}" rel="stylesheet"></script>
    <script src="{{ asset('js/admindashboardscript.js') }}"></script>
</head>
  ...
  <div class="row">
    <div id="sidebar" class="d-flex">
        ...
        <div class="sidebar-menu">
            <ul class="nav flex-column" id="">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="auto"
    ...
    <main>
        ...
        <nav id="sidebar" class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
            style=" postion:fixed; width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li id="Overview" class="nav-item active" style="margin-top:5%">
                    <a class="nav-link active" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="auto" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-home">
        ...
        <div class="container d-flex flex-column px-0" style="max-width:none;">
            {{-- NAVBAR --}}
            <nav id="navbar" class="d-flex flex-row navbar navbar-expand-lg"
                style="position:inherit; height:10%; width:100%; display:flex;">
                <div class="container-fluid justify-content-end">
                    <div class="dropdown" style="position: absolute;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="dropdown-menu">
