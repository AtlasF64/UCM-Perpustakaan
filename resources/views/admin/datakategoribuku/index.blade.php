...
<div class="container" style="padding:30px;padding-top:65px">
    ...
    <?php endif;?>
  	<a href="{{ url('datakategoribuku') }}/create" class="btn btn-primary" style="margin-left:-15px;">Tambah Data</a>
	<div class="row">
	        ...
	        @foreach($datakategoribuku as $key => $value)
	          	<tr>
	            	...
	            	<td style="text-align:right;color:blue">
			          	<a href="{{ url('datakategoribuku') }}/{{$value->id_kategoribuku}}/edit" style="color:green"><i class="fa fa-edit"></i></a>
			        </td>
	            	<td>
	            		<button type="button" class="notabutton" data-toggle="modal" data-target="#exampleModal2{{$value->id_kategoribuku}}" style="float:right"><i class="fa fa-trash"></i></button>
	            		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModal2{{$value->id_kategoribuku}}" aria-hidden="true" id="exampleModal2{{$value->id_kategoribuku}}" style="margin-top:100px">
                              ...
                              <div class="modal-footer">
                                <div class="row">
                                    ...
                                    <div class="col-md-2" style="margin-top:10px">
                                    	...
                                    	<form method="POST" action="{{ url('datakategoribuku') }}/{{$value->id_kategoribuku}}" accept-charset="UTF-8">
