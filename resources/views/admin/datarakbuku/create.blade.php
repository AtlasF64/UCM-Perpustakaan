...
<div class="container" style="padding:20px;padding-top:75px">
    ...
    <?php endif;?>
	<div class="row">
		<form class="form-horizontal" enctype="multipart/form-data" style="padding:20px" role="form" method="POST" action="{{url('datarakbuku')}}">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			<div class="form-group">
				<label id="rakbuku" class="col-md-4 control-label">Rak Buku <font style="color:red">*</font></label>
				<div class="col-md-6">
					<textarea id="rakbuku" class="form-control" name="rakbuku" maxlength="30" required>{{ old('rakbuku') }}</textarea>
				</div>
			</div>
			<div class="form-group">
