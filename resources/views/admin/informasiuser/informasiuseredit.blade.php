			...
			<div class="row">
                ...
                <div class="col-md-6" style="padding:0px">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        ...
                        <input type="text" class="form-control" name="email" value="{{$user->email}}" required="required">
                    </div>
                </div>
                <div class="col-md-3">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="padding:0px">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        ...
                        <input type="text" class="form-control" name="nimnidnnip" value="{{$user->nimnidnnip}}" required="required">
                    </div>
                </div>
                <div class="col-md-3">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="padding:0px">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        ...
                        <input type="number" class="form-control" name="nomortelepon" value="{{$user->nomortelepon}}" required="required">
                    </div>
                </div>
                <div class="col-md-3">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="padding:0px">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        ...
                        <input type="text" class="form-control" name="alamat" value="{{$user->alamat}}" required="required">
                    </div>
                </div>
                <div class="col-md-3">
                </div>
